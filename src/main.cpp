...
uint256 hashGenesisBlock("0xde31aa9fd17b8f1ffb399d615b220c37466b7539ee484e31f0d46424287dded0");
...
const string strMessageMagic = "DoingCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 0.35 * 24 * 60 * 60; // DoingCoin: 0.35 days
static const int64 nTargetSpacing = 560; // DoingCoin: 5 minutes
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal DoingCoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "DoingCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	// vMerkleTree: 5a2e19825b
        ...
        block.nVersion = 1;
        block.nTime    = 1404440083;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085847681;

        if (fTestNet)
        {
            block.nTime    = 140444083;
